...
public:
	...
	virtual void TranslateMatrix(double x, double y, double z) const;
	virtual void RotateMatrix(double angle) const;
	virtual void SetImagePixels(uint8* buffer, uint16 width, uint16 height) const;
